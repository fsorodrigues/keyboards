...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_89(
        ...
        _______, KC_LCTL,  KC_LOPT,                    KC_LCMD,      KC_SPC,       KC_BSPC,          KC_SPC,       MO(MAC_FN),                                           KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [WIN_BASE] = LAYOUT_ansi_89(
        ...
        _______, KC_LSFT, KC_Z,         KC_X,         KC_C,         KC_V,         KC_B,  KC_B,  KC_N,         KC_M,         KC_COMM,      KC_DOT,          KC_SLSH, KC_RSFT, KC_UP,
        _______, KC_LCTL, KC_LWIN,                    KC_LALT,      KC_SPC,       KC_BSPC,                    KC_SPC,       MO(WIN_FN),                             KC_LEFT, KC_DOWN, KC_RGHT),
