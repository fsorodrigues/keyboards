...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_89(
        ...
        LSG(KC_V),  KC_LCTL, KC_LOPT,                    KC_LCMD,      KC_SPC,       MO(MAC_NUMPAD),       KC_SPC,                         KC_RCMD,                                              KC_LEFT,    KC_DOWN, KC_RGHT),
    ...
    [MAC_FN] = LAYOUT_ansi_89(
        ...
        _______,    _______, S(KC_2),      S(KC_1),      KC_LBRC,    KC_RBRC,        S(KC_MINS),           _______,          _______,      NK_TOGG,      _______,      _______,         _______, _______,    _______,
    ...
    [MAC_NUMPAD] = LAYOUT_ansi_89(
        ...
        _______,    _______, _______,      _______,      _______,   _______,         _______,              _______,          KC_4,         KC_5,         KC_6,         S(KC_EQL),       _______, _______,             _______,
        _______,    _______, _______,      _______,      _______,   _______,         _______,              _______,          KC_COMM,      KC_1,         KC_2,         KC_3,            KC_ENT,  _______,    _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [MAC_NUMPAD]   = { ENCODER_CCW_CW(RM_VALD, RM_VALU) },
    [WIN_BASE]     = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [WIN_FN]       = { ENCODER_CCW_CW(RM_VALD, RM_VALU) },
    [WIN_NUMPAD]   = { ENCODER_CCW_CW(RM_VALD, RM_VALU) }
};
