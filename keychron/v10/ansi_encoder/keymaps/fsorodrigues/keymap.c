...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_ansi_89(
        ...
        _______,    _______, S(KC_2),      S(KC_1),      KC_LBRC,    KC_RBRC,        S(KC_MINS),           _______,              _______,      _______,      _______,      _______,         _______, _______,    _______,
    ...
    [MAC_NUMPAD] = LAYOUT_ansi_89(
        ...
        _______,    RM_TOGG, RM_NEXT,      RM_VALU,      RM_HUEU,   RM_SATU,         RM_SPDU,              _______,              KC_7,         KC_8,         KC_9,         KC_MINS,         _______, _______,    _______, _______,
        _______,    _______, RM_PREV,      RM_VALD,      RM_HUED,   RM_SATD,         RM_SPDD,              _______,              KC_4,         KC_5,         KC_6,         S(KC_EQL),       _______, _______,             _______,
