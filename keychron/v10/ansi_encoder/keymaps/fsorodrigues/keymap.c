...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_89(
        ...
        _______, KC_ESC,  LCMD_T(KC_A), LOPT_T(KC_S), LSFT_T(KC_D), LCTL_T(KC_F), KC_G,           KC_H,    RCTL_T(KC_J), RSFT_T(KC_K), ROPT_T(KC_L), RCMD_T(KC_SCLN), KC_QUOT, KC_ENT,              KC_HOME,
    ...
    [MAC_FN] = LAYOUT_ansi_89(
        ...
        _______, _______, S(KC_4), KC_MINS, S(KC_LBRC), S(KC_RBRC), S(KC_EQL),  RM_TOGG, RM_NEXT, RM_VALU, RM_HUEU, RM_SATU, RM_SPDU, _______, _______,          _______,
        _______, _______, S(KC_7), S(KC_8), S(KC_9),    S(KC_0),    KC_EQL,     _______, RM_PREV, RM_VALD, RM_HUED, RM_SATD, RM_SPDD,          _______,          _______,
        _______, _______, S(KC_2), S(KC_1), KC_LBRC,    KC_RBRC,    S(KC_MINS), _______, _______, NK_TOGG, _______, _______, _______, _______, _______, _______,
        _______, _______, _______,          _______,    _______,    _______,                      _______,          _______,                   _______, _______, _______),

    [MAC_NUMPAD] = LAYOUT_ansi_89(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    [WIN_BASE] = LAYOUT_ansi_89(
        ...
        _______, KC_GRV,  KC_1,         KC_2,         KC_3,         KC_4,         KC_5,           KC_6,   KC_7,         KC_8,         KC_9,         KC_0,            KC_MINS, KC_EQL,     KC_BSPC, KC_PGUP,
        _______, KC_TAB,  KC_Q,         KC_W,         KC_E,         KC_R,         KC_T,           KC_Y,   KC_U,         KC_I,         KC_O,         KC_P,            KC_LBRC, KC_RBRC,    KC_BSLS, KC_PGDN,
        _______, KC_ESC,  LWIN_T(KC_A), LALT_T(KC_S), LSFT_T(KC_D), LCTL_T(KC_F), KC_G,           KC_H,   RCTL_T(KC_J), RSFT_T(KC_K), RALT_T(KC_L), RWIN_T(KC_SCLN), KC_QUOT, KC_ENT,              KC_HOME, _______, KC_LSFT, KC_Z,         KC_X,         KC_C,         KC_V,         KC_B,           KC_B,   KC_N,         KC_M,         KC_COMM,      KC_DOT,          KC_SLSH, MO(WIN_FN), KC_UP,
